...
# the estimate itself isn't exact -- see redis_guard.py's
...
POLITICAL_CENTROID_MODEL_VERSION = os.environ.get("POLITICAL_CENTROID_MODEL_VERSION")
QUALITY_MODEL_VERSION = os.environ.get("QUALITY_MODEL_VERSION")
...
# R2_CORPUS_ACCOUNT_ID carries the same value as R2_MODELS_ACCOUNT_ID (one

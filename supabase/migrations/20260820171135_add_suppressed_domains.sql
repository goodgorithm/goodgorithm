...
-- restart needed" precedent as blocked_authors and suppressed_terms:
-- today, by hand, via the Supabase SQL editor -- no admin UI/CLI,
-- deliberately, same as those two tables.
--
...
-- suppressed_terms: a 20-post hand sample of amazon.com/
...
-- which needed a follow-up migration to add it) -- no reason to

...
// loading, in place of the plain "Loading feed…" line, so a card-shaped
// block is on screen early rather than after the JS bundle + a live feed
// fetch (see the wiki's Web Internals page). aria-hidden: it carries no
// information, and index.html's static shell already provides an sr-only
// role="status" during the pre-hydration window.
const CARD_COUNT = 3;
